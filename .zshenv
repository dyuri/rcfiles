...
export PATH CDPATH LD_LIBRARY_PATH USERNAME JDK_HOME DICTIONARY LS_COLORS LS_OPTIONS SDL_AUDIODRIVER AUDIODEV EDITOR WINEDITOR HISTSIZE HISTFILE SAVEHIST PYTHONPATH GREP_OPTIONS PYTHONSTARTUP
