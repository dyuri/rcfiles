module completions {
  ...
  export extern "atuin dotfiles alias import" [
    --help(-h)                # Print help
  ]
  ...
  # Import aliases set in the current shell
  export extern "atuin dotfiles alias help import" [
  ]
  ...
  # Import aliases set in the current shell
  export extern "atuin dotfiles help alias import" [
  ]
  ...
  # Import aliases set in the current shell
  export extern "atuin help dotfiles alias import" [
  ]
