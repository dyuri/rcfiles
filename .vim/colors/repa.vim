...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=darkcyan
    CSAHi NonText term=bold cterm=bold ctermbg=bg ctermfg=225 gui=bold guibg=bg guifg=lightMagenta
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=231 ctermfg=28 gui=NONE guibg=White guifg=DarkGreen
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=Green
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=59 ctermfg=fg gui=NONE guibg=#403820 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=59 ctermfg=fg gui=NONE guibg=#403820 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=255 ctermfg=17 gui=NONE guibg=fg guifg=bg
    ...
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=157 gui=NONE guibg=bg guifg=LightGreen
    CSAHi Float term=NONE cterm=NONE ctermbg=bg ctermfg=157 gui=NONE guibg=bg guifg=LightGreen
    CSAHi Operator term=NONE cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=Yellow
    CSAHi Repeat term=NONE cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=Red
    ...
    CSAHi Number term=NONE cterm=NONE ctermbg=bg ctermfg=157 gui=NONE guibg=bg guifg=LightGreen
    ...
    CSAHi tcltkWidget term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi tcltkCommand term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi tcltkPackConf term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi tcltlWidgetSwitch term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimTclRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi schemeStruc term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi schemeQuoted term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi schemeStrucRestricted term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi schemeUnquote term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi schemeOther term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi matchPlace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimMzSchemeRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi DiffChange term=bold cterm=NONE ctermbg=201 ctermfg=fg gui=NONE guibg=magenta guifg=fg
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=255 ctermfg=28 gui=NONE guibg=White guifg=DarkGreen
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=Green
    CSAHi vimSynKeyRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=95 ctermfg=fg gui=NONE guibg=#403820 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=95 ctermfg=fg gui=NONE guibg=#403820 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=255 ctermfg=17 gui=NONE guibg=fg guifg=bg
    CSAHi vimSyncLinebreak term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyCaseExpression term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyConditionalExpression term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi vimFunction term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlVarBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=30 gui=NONE guibg=bg guifg=darkcyan
    CSAHi NonText term=bold cterm=bold ctermbg=bg ctermfg=219 gui=bold guibg=bg guifg=lightMagenta
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=cyan
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=red guifg=white
    ...
    CSAHi ModeMsg term=bold cterm=bold ctermbg=bg ctermfg=226 gui=bold guibg=bg guifg=yellow
    CSAHi LineNr term=underline cterm=NONE ctermbg=17 ctermfg=46 gui=NONE guibg=#080840 guifg=green
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=231 ctermfg=22 gui=NONE guibg=White guifg=DarkGreen
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=Green
    CSAHi vimSynKeyRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=58 ctermfg=fg gui=NONE guibg=#403820 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=58 ctermfg=fg gui=NONE guibg=#403820 guifg=fg
    ...
    CSAHi vimSyncLines term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncMatch term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=120 gui=NONE guibg=bg guifg=LightGreen
    CSAHi Float term=NONE cterm=NONE ctermbg=bg ctermfg=120 gui=NONE guibg=bg guifg=LightGreen
    CSAHi Operator term=NONE cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=Yellow
    CSAHi Repeat term=NONE cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=Red
    CSAHi Todo term=NONE cterm=NONE ctermbg=226 ctermfg=21 gui=NONE guibg=Yellow guifg=Blue
    CSAHi rubyMultilineComment term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi Number term=NONE cterm=NONE ctermbg=bg ctermfg=120 gui=NONE guibg=bg guifg=LightGreen
    CSAHi vimGlobal term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlFiledescStatementComma term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi tcltkWidget term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi tcltkCommand term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi vimFunction term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlVarBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=darkcyan
    CSAHi NonText term=bold cterm=bold ctermbg=bg ctermfg=75 gui=bold guibg=bg guifg=lightMagenta
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=79 ctermfg=20 gui=NONE guibg=White guifg=DarkGreen
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=28 gui=NONE guibg=bg guifg=Green
    CSAHi vimSynKeyRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=80 ctermfg=fg gui=NONE guibg=#403820 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=80 ctermfg=fg gui=NONE guibg=#403820 guifg=fg
    ...
    CSAHi vimSyncLines term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncMatch term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=45 gui=NONE guibg=bg guifg=LightGreen
    CSAHi Float term=NONE cterm=NONE ctermbg=bg ctermfg=45 gui=NONE guibg=bg guifg=LightGreen
    CSAHi Operator term=NONE cterm=NONE ctermbg=bg ctermfg=76 gui=NONE guibg=bg guifg=Yellow
    CSAHi Repeat term=NONE cterm=NONE ctermbg=bg ctermfg=64 gui=NONE guibg=bg guifg=Red
    ...
    CSAHi Number term=NONE cterm=NONE ctermbg=bg ctermfg=45 gui=NONE guibg=bg guifg=LightGreen
    CSAHi vimGlobal term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlFiledescStatementComma term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi tcltkWidget term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi tcltkCommand term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimAuSyntax term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi DiffChange term=bold cterm=NONE ctermbg=67 ctermfg=fg gui=NONE guibg=magenta guifg=fg
